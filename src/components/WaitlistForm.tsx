    ...
    <div className="w-full bg-white border border-zinc-200 rounded-3xl shadow-2xl relative overflow-hidden text-left">
      {submitted ? (
        <div className="p-16 text-center">
          ...
          <button onClick={() => setSubmitted(false)} className="inline-flex items-center px-8 py-3 bg-zinc-900 hover:bg-zinc-800 text-white font-bold rounded-xl transition-colors shadow-lg">
            Submit Another
          </button>
        </div>
      ) : (
